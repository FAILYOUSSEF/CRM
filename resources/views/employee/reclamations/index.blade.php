...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-crm-muted mt-1">Submit and track your complaints</p>
    </div>
    <a href="{{ route('employee.reclamations.create') }}" class="bg-crm-accent text-white px-4 py-2.5 rounded-crm hover:bg-blue-500 transition-all duration-200 shadow-lg shadow-crm-accent/30 transform hover:-translate-y-0.5 text-sm font-bold flex items-center gap-2">
...
<div x-data="filterPanel()" class="bg-crm-surface border border-crm-border rounded-crm shadow-sm mb-6">
    ...
    <div x-show="open" x-transition class="p-5 space-y-6">
        <form method="GET" action="{{ route('employee.reclamations.index') }}" id="filterForm" class="space-y-6">
            <!-- Search Input -->
            <div>
            ...
            <div class="flex gap-3 pt-4 border-t border-crm-border">
                ...
                <a href="{{ route('employee.reclamations.index') }}" class="flex-1 bg-crm-bg3 text-crm-muted px-4 py-2.5 rounded-crm hover:bg-crm-bg2 transition-colors font-medium text-sm flex items-center justify-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="space-y-4 mb-6">
    ...
    <div class="bg-crm-surface border border-crm-border rounded-crm shadow-sm p-6 group hover:border-crm-accent/50 transition-colors">
        <div class="flex items-start justify-between mb-4">
            <div class="flex-1">
                <a href="{{ route('employee.reclamations.show', $rec) }}" class="font-semibold text-crm-text text-lg group-hover:text-crm-accent transition-colors">{{ $rec->titre }}</a>
        ...
        <a href="{{ route('employee.reclamations.show', $rec) }}" class="inline-flex items-center gap-2 text-crm-accent hover:text-blue-400 transition-colors text-sm font-medium">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-crm-surface border border-crm-border rounded-crm shadow-sm p-12 text-center">
        ...
        <p class="text-crm-muted font-medium">No reclamations submitted.</p>
        <p class="text-sm text-crm-muted mt-1"><a href="{{ route('employee.reclamations.create') }}" class="text-crm-accent hover:underline">Create your first reclamation</a></p>
    </div>
    @endforelse
</div>
