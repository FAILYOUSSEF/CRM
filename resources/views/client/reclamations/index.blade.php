...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('client.reclamations.create') }}" class="bg-crm-accent text-white px-4 py-2 rounded-crm hover:bg-blue-600 text-xs font-semibold">+ New Reclamation</a>
</div>
<div class="space-y-4">
