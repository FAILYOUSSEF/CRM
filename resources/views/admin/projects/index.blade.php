...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.projects.create') }}" class="bg-crm-accent text-white px-4 py-2.5 rounded-crm hover:bg-blue-500 transition-all duration-200 shadow-lg shadow-crm-accent/30 transform hover:-translate-y-0.5 text-sm font-bold flex items-center gap-2">
